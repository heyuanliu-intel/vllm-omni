...
class OmniDiffusionConfig:
    ...
    # but the encoders and VAEs do not. Only plain layer-wise offloading
    # consumes this; distributed layer-wise offloading ignores it (and the
    # offload config logs a warning when that happens).
