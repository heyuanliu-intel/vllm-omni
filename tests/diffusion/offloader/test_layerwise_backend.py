...
def test_layerwise_backend_leaves_pipeline_staged_vae_in_host_memory() -> None:
...
def test_layerwise_backend_keeps_undeclared_vae_resident() -> None:
...
def test_layerwise_backend_keeps_unstageable_vae_resident() -> None:
